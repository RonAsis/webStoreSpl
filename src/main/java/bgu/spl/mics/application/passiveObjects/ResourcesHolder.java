...
public class ResourcesHolder {
	...
	private int usedVehicles; // the vehicles that are being used
	private int amountVehicle; // the amount of vehicles
	...
	private boolean haveFreeVehicle() {
		return this.amountVehicle - this.usedVehicles > 0;
	}
